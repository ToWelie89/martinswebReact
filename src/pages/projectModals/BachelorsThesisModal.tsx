...
export const BachelorsThesisModal = (props: any) => {
    ...
    return (
        <ProjectModal id="exjobbModal" onClose={props.onClose} isOpen={props.isOpen}>
            ...
            <div className="modal-footer">
                <a className="button floatRight" href="./../src/documents/BachelorsThesisReport.pdf" target="_blank" download="BachelorsThesisReport.pdf">
                    <p text="Report"></p>
                </a>
            </div>
        </ProjectModal>
