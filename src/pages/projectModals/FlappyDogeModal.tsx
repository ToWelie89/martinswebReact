...
export const FlappyDogeModal = (props: any) => {
    ...
    return (
        <ProjectModal id="flappyDogeModal" onClose={props.onClose} isOpen={props.isOpen}>
            ...
            <div className="modal-footer">
                <a className="button floatRight" href="https://github.com/ToWelie89/FlappyDoge" target="_blank">
                    <p text="Code"></p>
                </a>
