...
function resizeContent() {
    ...
    if (!document.getElementById('sonesson3dlogo')) return
...
window.start3dAnimation = () => {
    const isAlreadyRunning = document.querySelector('#sonesson3dlogo canvas');
    ...
    assetLoader.load('src/assets/sonesson_logo.glb', function (gltf) {
