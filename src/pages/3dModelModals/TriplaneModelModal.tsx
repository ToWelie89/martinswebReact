    ...
    return (
        <ThreeDModelModal onClose={props.onClose} isOpen={props.isOpen} onAfterOpen={() => {
            ...
            <div className="modal-body">
                ...
                This is a plane based on the old style "triplane" design commonly used in WW1. This model is actually based on an actual model, namely
                the <a href="https://ca.wikipedia.org/wiki/Sopwith_Triplane" target="_blank">Sopwith Triplane</a>. I based my 3D model on the blueprint
                of the original plane, in order to get the exact proportions. I doubt that the original plane was pink however. I also added a propeller
                animation and an animated pilot. I also integrated this model into my <Link to={'/3dmodels/portfolioanimation'}>start animation</Link>.
                </p>
            </div>
        </ThreeDModelModal>
    )
