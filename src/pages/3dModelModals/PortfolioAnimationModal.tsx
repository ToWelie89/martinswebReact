...
export const PortfolioAnimationModal = (props: any) => {
    ...
    const onAfterOpen = () => {
        ...
        (window as any).initiate3dModel(
            ...
            (animations: any) => { // Animations to play on loop
            ...
            (animations: any) => { // Animations to play once
        ...
        <ThreeDModelModal onClose={props.onClose} isOpen={props.isOpen} onAfterOpen={() => {
            ...
            <div className="modal-body">
                ...
                <p className="marginTop--double">
                    This is the same 3D animation that I have on the start page of my portfolio. I made a simple landscape in Blender that I textured as well.
                    I made the animations of the clouds moving and the text falling down from the sky. Then I proceeded to add more elements, such as the plane,
                    the flying bird, the car driving the and the guy peaking outside of the windows in the castle. They are all separate actions, animated in Blender
                    and saved into the file itself. Three.js then loads the file as a glb-file and programmatically starts playing the baked actions.
                </p>
            </div>
        </ThreeDModelModal>
    )
